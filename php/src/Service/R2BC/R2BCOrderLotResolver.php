...
class R2BCOrderLotResolver
{
    ...
    private static array $lotList = [0.01, 0.01, 0.02, 0.02, 0.03, 0.03, 0.05, 0.07, 0.1, 0.13, 0.17, 0.23, 0.34, 0.4, 0.55];
    private static array $factorDictionary = [1, 1, 2, 2, 3, 3, 5, 8, 10, 13, 17, 21, 34, 55];
