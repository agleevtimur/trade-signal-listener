...
class R2BCSignalHandler extends SignalHandlerAbstract
{
    ...
    protected function parse(string $text): ?BaseOrderDTO
    {
        ...
        return $this->parseAfter($text, $type, $parsedSignal);
    }
    ...
    private function parseAfter(string $text, string $orderType, NewOrderDTO $parsedSignal): NewOrderDTO
    {
